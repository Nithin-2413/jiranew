...
const ConfigurationModal = ({ open, onClose, onSave, initialConfig }) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[650px] bg-gradient-to-br from-slate-900 to-slate-800 border-slate-700 text-white" data-testid="config-modal">
        <DialogHeader>
        ...
        <div className="space-y-5 mt-4">
          <div>
            <Label htmlFor="jira-url" className="text-slate-200">JIRA URL *</Label>
            <Input
              id="jira-url"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <Label htmlFor="jira-email" className="text-slate-200">Email *</Label>
              <Input
                id="jira-email"
            ...
            <div>
              <Label htmlFor="api-token" className="text-slate-200">API Token *</Label>
              <Input
                id="api-token"
          ...
          <div>
            <Label htmlFor="project-key" className="text-slate-200">Project Key *</Label>
            <Input
              id="project-key"
          ...
          <div className="pt-2 border-t border-slate-700">
            <Label htmlFor="story-points-field" className="text-slate-200 flex items-center gap-2">
              Story Points Field
              {loadingFields && <Loader2 className="h-4 w-4 animate-spin text-cyan-400" />}
            </Label>
            <Select
            ...
            >
              ...
              <SelectContent className="bg-slate-800 border-slate-600">
                <SelectItem value="auto" className="text-slate-200 focus:bg-slate-700">
